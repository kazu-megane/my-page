      ...
      <div>
        <ul className={style.HomeContent__images}>
          <li className={style.HomeContent__image}>
            <img src="/home.png" alt="home" width="633" height="633" className={style.HomeContent__imageContent} />
          </li>
          <li className={style.HomeContent__image}>
            <img src="/home2.png" alt="home2" width="633" height="633" className={style.HomeContent__imageContent} />
